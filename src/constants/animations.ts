...
const deregentMob = keyframes`
0.00% { transform: translateX(0px) translateY(0px);}
0.555555556% { transform: translateX(-5px) translateY(-7.07px);}
1.111111111% { transform: translateX(-10px) translateY(-13.45px);}
1.666666667% { transform: translateX(-15px) translateY(-19.25px);}
2.222222222% { transform: translateX(-20px) translateY(-24.56px);}
2.777777778% { transform: translateX(-25px) translateY(-29.44px);}
3.333333333% { transform: translateX(-30px) translateY(-33.95px);}
3.888888889% { transform: translateX(-35px) translateY(-38.11px);}
4.444444444% { transform: translateX(-40px) translateY(-41.96px);}
5% { transform: translateX(-45px) translateY(-45.53px);}
5.555555556% { transform: translateX(-50px) translateY(-48.84px);}
6.111111111% { transform: translateX(-55px) translateY(-51.9px);}
6.666666667% { transform: translateX(-60px) translateY(-54.73px);}
7.222222222% { transform: translateX(-65px) translateY(-57.34px);}
7.777777778% { transform: translateX(-70px) translateY(-59.75px);}
8.333333333% { transform: translateX(-75px) translateY(-61.96px);}
8.888888889% { transform: translateX(-80px) translateY(-63.99px);}
9.444444444% { transform: translateX(-85px) translateY(-65.83px);}
10% { transform: translateX(-90px) translateY(-67.49px);}
10.55555556% { transform: translateX(-95px) translateY(-68.99px);}
11.11111111% { transform: translateX(-100px) translateY(-70.32px);}
11.66666667% { transform: translateX(-105px) translateY(-71.49px);}
12.22222222% { transform: translateX(-110px) translateY(-72.51px);}
12.77777778% { transform: translateX(-115px) translateY(-73.36px);}
13.33333333% { transform: translateX(-120px) translateY(-74.07px);}
13.88888889% { transform: translateX(-125px) translateY(-74.63px);}
14.44444444% { transform: translateX(-130px) translateY(-75.03px);}
15% { transform: translateX(-135px) translateY(-75.29px);}
15.55555556% { transform: translateX(-140px) translateY(-75.40px);}
16.11111111% { transform: translateX(-145px) translateY(-75.36px);}
16.66666667% { transform: translateX(-150px) translateY(-75.18px);}
17.22222222% { transform: translateX(-155px) translateY(-74.85px);}
17.77777778% { transform: translateX(-160px) translateY(-74.33px);}
18.33333333% { transform: translateX(-165px) translateY(-73.48px);}
18.88888889% { transform: translateX(-170px) translateY(-72.28px);}
19.44444444% { transform: translateX(-175px) translateY(-70.71px);}
20% { transform: translateX(-180px) translateY(-68.74px);}
20.55555556% { transform: translateX(-185px) translateY(-66.33px);}
21.11111111% { transform: translateX(-190px) translateY(-63.44px);}
21.66666667% { transform: translateX(-195px) translateY(-60px);}
22.22222222% { transform: translateX(-200px) translateY(-55.9px);}
22.77777778% { transform: translateX(-205px) translateY(-50.99px);}
23.33333333% { transform: translateX(-210px) translateY(-45px);}
23.88888889% { transform: translateX(-215px) translateY(-37.42px);}
24.44444444% { transform: translateX(-220px) translateY(-26.93px);}
25% { transform: translateX(-225px) translateY(0px);}
25.55555556% { transform: translateX(-220px) translateY(26.93px);}
26.11111111% { transform: translateX(-215px) translateY(37.42px);}
26.66666667% { transform: translateX(-210px) translateY(45px);}
27.22222222% { transform: translateX(-205px) translateY(50.99px);}
27.77777778% { transform: translateX(-200px) translateY(55.9px);}
28.33333333% { transform: translateX(-195px) translateY(60px);}
28.88888889% { transform: translateX(-190px) translateY(63.44px);}
29.44444444% { transform: translateX(-185px) translateY(66.33px);}
30% { transform: translateX(-180px) translateY(68.74px);}
30.55555556% { transform: translateX(-175px) translateY(70.71px);}
31.11111111% { transform: translateX(-170px) translateY(72.28px);}
31.66666667% { transform: translateX(-165px) translateY(73.48px);}
32.22222222% { transform: translateX(-160px) translateY(74.33px);}
32.77777778% { transform: translateX(-155px) translateY(74.85px);}
33.33333333% { transform: translateX(-150px) translateY(75.18px);}
33.88888889% { transform: translateX(-145px) translateY(75.36px);}
34.44444444% { transform: translateX(-140px) translateY(75.40px);}
35% { transform: translateX(-135px) translateY(75.29px);}
35.55555556% { transform: translateX(-130px) translateY(75.03px);}
36.11111111% { transform: translateX(-125px) translateY(74.63px);}
36.66666667% { transform: translateX(-120px) translateY(74.07px);}
37.22222222% { transform: translateX(-115px) translateY(73.36px);}
37.77777778% { transform: translateX(-110px) translateY(72.51px);}
38.33333333% { transform: translateX(-105px) translateY(71.49px);}
38.88888889% { transform: translateX(-100px) translateY(70.32px);}
39.44444444% { transform: translateX(-95px) translateY(68.99px);}
40% { transform: translateX(-90px) translateY(67.49px);}
40.55555556% { transform: translateX(-85px) translateY(65.83px);}
41.11111111% { transform: translateX(-80px) translateY(63.99px);}
41.66666667% { transform: translateX(-75px) translateY(61.96px);}
42.22222222% { transform: translateX(-70px) translateY(59.75px);}
42.77777778% { transform: translateX(-65px) translateY(57.34px);}
43.33333333% { transform: translateX(-60px) translateY(54.73px);}
43.88888889% { transform: translateX(-55px) translateY(51.9px);}
44.44444444% { transform: translateX(-50px) translateY(48.84px);}
45% { transform: translateX(-45px) translateY(45.53px);}
45.55555556% { transform: translateX(-40px) translateY(41.96px);}
46.11111111% { transform: translateX(-35px) translateY(38.11px);}
46.66666667% { transform: translateX(-30px) translateY(33.95px);}
47.22222222% { transform: translateX(-25px) translateY(29.44px);}
47.77777778% { transform: translateX(-20px) translateY(24.56px);}
48.33333333% { transform: translateX(-15px) translateY(19.25px);}
48.88888889% { transform: translateX(-10px) translateY(13.45px);}
49.44444444% { transform: translateX(-5px) translateY(7.07px);}
50% { transform: translateX(0px) translateY(0px);}
50.55555556% { transform: translateX(5px) translateY(-7.07px);}
51.11111111% { transform: translateX(10px) translateY(-13.45px);}
51.66666667% { transform: translateX(15px) translateY(-19.25px);}
52.22222222% { transform: translateX(20px) translateY(-24.56px);}
52.77777778% { transform: translateX(25px) translateY(-29.44px);}
53.33333333% { transform: translateX(30px) translateY(-33.95px);}
53.88888889% { transform: translateX(35px) translateY(-38.11px);}
54.44444444% { transform: translateX(40px) translateY(-41.96px);}
55% { transform: translateX(45px) translateY(-45.53px);}
55.55555556% { transform: translateX(50px) translateY(-48.84px);}
56.11111111% { transform: translateX(55px) translateY(-51.9px);}
56.66666667% { transform: translateX(60px) translateY(-54.73px);}
57.22222222% { transform: translateX(65px) translateY(-57.34px);}
57.77777778% { transform: translateX(70px) translateY(-59.75px);}
58.33333333% { transform: translateX(75px) translateY(-61.96px);}
58.88888889% { transform: translateX(80px) translateY(-63.99px);}
59.44444444% { transform: translateX(85px) translateY(-65.83px);}
60% { transform: translateX(90px) translateY(-67.49px);}
60.55555556% { transform: translateX(95px) translateY(-68.99px);}
61.11111111% { transform: translateX(100px) translateY(-70.32px);}
61.66666667% { transform: translateX(105px) translateY(-71.49px);}
62.22222222% { transform: translateX(110px) translateY(-72.51px);}
62.77777778% { transform: translateX(115px) translateY(-73.36px);}
63.33333333% { transform: translateX(120px) translateY(-74.07px);}
63.88888889% { transform: translateX(125px) translateY(-74.63px);}
64.44444444% { transform: translateX(130px) translateY(-75.03px);}
65% { transform: translateX(135px) translateY(-75.29px);}
65.55555556% { transform: translateX(140px) translateY(-75.40px);}
66.11111111% { transform: translateX(145px) translateY(-75.36px);}
66.66666667% { transform: translateX(150px) translateY(-75.18px);}
67.22222222% { transform: translateX(155px) translateY(-74.85px);}
67.77777778% { transform: translateX(160px) translateY(-74.33px);}
68.33333333% { transform: translateX(165px) translateY(-73.48px);}
68.88888889% { transform: translateX(170px) translateY(-72.28px);}
69.44444444% { transform: translateX(175px) translateY(-70.71px);}
70% { transform: translateX(180px) translateY(-68.74px);}
70.55555556% { transform: translateX(185px) translateY(-66.33px);}
71.11111111% { transform: translateX(190px) translateY(-63.44px);}
71.66666667% { transform: translateX(195px) translateY(-60px);}
72.22222222% { transform: translateX(200px) translateY(-55.9px);}
72.77777778% { transform: translateX(205px) translateY(-50.99px);}
73.33333333% { transform: translateX(210px) translateY(-45px);}
73.88888889% { transform: translateX(215px) translateY(-37.42px);}
74.44444444% { transform: translateX(220px) translateY(-26.93px);}
75% { transform: translateX(225px) translateY(0px);}
75.55555556% { transform: translateX(220px) translateY(26.93px);}
76.11111111% { transform: translateX(215px) translateY(37.42px);}
76.66666667% { transform: translateX(210px) translateY(45px);}
77.22222222% { transform: translateX(205px) translateY(50.99px);}
77.77777778% { transform: translateX(200px) translateY(55.9px);}
78.33333333% { transform: translateX(195px) translateY(60px);}
78.88888889% { transform: translateX(190px) translateY(63.44px);}
79.44444444% { transform: translateX(185px) translateY(66.33px);}
80% { transform: translateX(180px) translateY(68.74px);}
80.55555556% { transform: translateX(175px) translateY(70.71px);}
81.11111111% { transform: translateX(170px) translateY(72.28px);}
81.66666667% { transform: translateX(165px) translateY(73.48px);}
82.22222222% { transform: translateX(160px) translateY(74.33px);}
82.77777778% { transform: translateX(155px) translateY(74.85px);}
83.33333333% { transform: translateX(150px) translateY(75.18px);}
83.88888889% { transform: translateX(145px) translateY(75.36px);}
84.44444444% { transform: translateX(140px) translateY(75.40px);}
85% { transform: translateX(135px) translateY(75.29px);}
85.55555556% { transform: translateX(130px) translateY(75.03px);}
86.11111111% { transform: translateX(125px) translateY(74.63px);}
86.66666667% { transform: translateX(120px) translateY(74.07px);}
87.22222222%{ transform: translateX(115px) translateY(73.36px);}
87.77777778% { transform: translateX(110px) translateY(72.51px);}
88.33333333% { transform: translateX(105px) translateY(71.49px);}
88.88888889% { transform: translateX(100px) translateY(70.32px);}
89.44444444% { transform: translateX(95px) translateY(68.99px);}
90% { transform: translateX(90px) translateY(67.49px);}
90.55555556% { transform: translateX(85px) translateY(65.83px);}
91.11111111% { transform: translateX(80px) translateY(63.99px);}
91.66666667% { transform: translateX(75px) translateY(61.96px);}
92.22222222% { transform: translateX(70px) translateY(59.75px);}
92.77777778% { transform: translateX(65px) translateY(57.34px);}
93.33333333% { transform: translateX(60px) translateY(54.73px);}
93.88888889% { transform: translateX(55px) translateY(51.9px);}
94.44444444% { transform: translateX(50px) translateY(48.84px);}
95% { transform: translateX(45px) translateY(45.53px);}
95.55555556% { transform: translateX(40px) translateY(41.96px);}
96.11111111% { transform: translateX(35px) translateY(38.11px);}
96.66666667% { transform: translateX(30px) translateY(33.95px);}
97.22222222% { transform: translateX(25px) translateY(29.44px);}
97.77777778% { transform: translateX(20px) translateY(24.56px);}
98.33333333% { transform: translateX(15px) translateY(19.25px);}
98.88888889% { transform: translateX(10px) translateY(13.45px);}
99.44444444% { transform: translateX(5px) translateY(7.07px);}
...
const montyPythonLiteReverse = keyframes`
0%   { transform: rotate(0deg); }
5%   { transform: rotate(-4deg); }
10%  { transform: rotate(6deg); }
15%  { transform: rotate(-9deg); }
