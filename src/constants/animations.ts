...
0.50% { transform: translateX(-3px) translateY(-6.28px);}
1.00% { transform: translateX(-6px) translateY(-11.62px);}
1.50% { transform: translateX(-9px) translateY(-16.3px);}
2.00% { transform: translateX(-12px) translateY(-20.48px);}
2.50% { transform: translateX(-15px) translateY(-24.24px);}
3.00% { transform: translateX(-18px) translateY(-27.66px);}
3.50% { transform: translateX(-21px) translateY(-30.79px);}
4.00% { transform: translateX(-24px) translateY(-33.66px);}
4.50% { transform: translateX(-27px) translateY(-36.31px);}
5.00% { transform: translateX(-30px) translateY(-38.76px);}
5.50% { transform: translateX(-33px) translateY(-41.02px);}
6.00% { transform: translateX(-36px) translateY(-43.11px);}
6.50% { transform: translateX(-39px) translateY(-45.04px);}
7.00% { transform: translateX(-42px) translateY(-46.83px);}
7.50% { transform: translateX(-45px) translateY(-48.48px);}
8.00% { transform: translateX(-48px) translateY(-50px);}
8.50% { transform: translateX(-51px) translateY(-51.39px);}
9.00% { transform: translateX(-54px) translateY(-52.67px);}
9.50% { transform: translateX(-57px) translateY(-53.83px);}
10.0% { transform: translateX(-60px) translateY(-54.89px);}
10.5% { transform: translateX(-63px) translateY(-55.84px);}
11.00% { transform: translateX(-66px) translateY(-56.68px);}
11.50% { transform: translateX(-69px) translateY(-57.43px);}
12.00% { transform: translateX(-72px) translateY(-58.08px);}
12.50% { transform: translateX(-75px) translateY(-58.64px);}
13.00% { transform: translateX(-78px) translateY(-59.1px);}
13.50% { transform: translateX(-81px) translateY(-59.46px);}
14.00% { transform: translateX(-84px) translateY(-59.74px);}
14.50% { transform: translateX(-87px) translateY(-59.93px);}
15.00% { transform: translateX(-90px) translateY(-60px);}
15.50% { transform: translateX(-93px) translateY(-59.92px);}
16.00% { transform: translateX(-96px) translateY(-59.7px);}
16.50% { transform: translateX(-99px) translateY(-59.32px);}
17.00% { transform: translateX(-102px) translateY(-58.79px);}
17.50% { transform: translateX(-105px) translateY(-58.09px);}
18.00% { transform: translateX(-108px) translateY(-57.24px);}
18.50% { transform: translateX(-111px) translateY(-56.2px);}
19.00% { transform: translateX(-114px) translateY(-54.99px);}
19.50% { transform: translateX(-117px) translateY(-53.58px);}
20.00% { transform: translateX(-120px) translateY(-51.96px);}
20.50% { transform: translateX(-123px) translateY(-50.11px);}
21.00% { transform: translateX(-126px) translateY(-48px);}
21.50% { transform: translateX(-129px) translateY(-45.6px);}
22.00% { transform: translateX(-132px) translateY(-42.85px);}
22.50% { transform: translateX(-135px) translateY(-39.69px);}
23.00% { transform: translateX(-138px) translateY(-36px);}
23.50% { transform: translateX(-141px) translateY(-31.61px);}
24.00% { transform: translateX(-144px) translateY(-26.15px);}
24.50% { transform: translateX(-147px) translateY(-18.73px);}
25.00% { transform: translateX(-150px) translateY(0px);}
25.50% { transform: translateX(-147px) translateY(18.73px);}
26.00% { transform: translateX(-144px) translateY(26.15px);}
26.50% { transform: translateX(-141px) translateY(31.61px);}
27.00% { transform: translateX(-138px) translateY(36px);}
27.50% { transform: translateX(-135px) translateY(39.69px);}
28.00% { transform: translateX(-132px) translateY(42.85px);}
28.50% { transform: translateX(-129px) translateY(45.6px);}
29.00% { transform: translateX(-126px) translateY(48px);}
29.50% { transform: translateX(-123px) translateY(50.11px);}
30.00% { transform: translateX(-120px) translateY(51.96px);}
30.50% { transform: translateX(-117px) translateY(53.58px);}
31.00% { transform: translateX(-114px) translateY(54.99px);}
31.50% { transform: translateX(-111px) translateY(56.2px);}
32.00% { transform: translateX(-108px) translateY(57.24px);}
32.50% { transform: translateX(-105px) translateY(58.09px);}
33.00% { transform: translateX(-102px) translateY(58.79px);}
33.50% { transform: translateX(-99px) translateY(59.32px);}
34.00% { transform: translateX(-96px) translateY(59.7px);}
34.50% { transform: translateX(-93px) translateY(59.92px);}
35.00% { transform: translateX(-90px) translateY(60px);}
35.50% { transform: translateX(-87px) translateY(59.93px);}
36.00% { transform: translateX(-84px) translateY(59.74px);}
36.50% { transform: translateX(-81px) translateY(59.46px);}
37.00% { transform: translateX(-78px) translateY(59.1px);}
37.50% { transform: translateX(-75px) translateY(58.64px);}
38.00% { transform: translateX(-72px) translateY(58.08px);}
38.50% { transform: translateX(-69px) translateY(57.43px);}
39.00% { transform: translateX(-66px) translateY(56.68px);}
39.50% { transform: translateX(-63px) translateY(55.84px);}
40.00% { transform: translateX(-60px) translateY(54.89px);}
40.50% { transform: translateX(-57px) translateY(53.83px);}
41.00% { transform: translateX(-54px) translateY(52.67px);}
41.50% { transform: translateX(-51px) translateY(51.39px);}
42.00% { transform: translateX(-48px) translateY(50px);}
42.50% { transform: translateX(-45px) translateY(48.48px);}
43.00% { transform: translateX(-42px) translateY(46.83px);}
43.50% { transform: translateX(-39px) translateY(45.04px);}
44.00% { transform: translateX(-36px) translateY(43.11px);}
44.50% { transform: translateX(-33px) translateY(41.02px);}
45.00% { transform: translateX(-30px) translateY(38.76px);}
45.50% { transform: translateX(-27px) translateY(36.31px);}
46.00% { transform: translateX(-24px) translateY(33.66px);}
46.50% { transform: translateX(-21px) translateY(30.79px);}
47.00% { transform: translateX(-18px) translateY(27.66px);}
47.50% { transform: translateX(-15px) translateY(24.24px);}
48.00% { transform: translateX(-12px) translateY(20.48px);}
48.50% { transform: translateX(-9px) translateY(16.3px);}
49.00% { transform: translateX(-6px) translateY(11.62px);}
49.50% { transform: translateX(-3px) translateY(6.28px);}
50.00% { transform: translateX(0px) translateY(0px);}
50.50% { transform: translateX(3px) translateY(-6.28px);}
51.00% { transform: translateX(6px) translateY(-11.62px);}
51.50% { transform: translateX(9px) translateY(-16.3px);}
52.00% { transform: translateX(12px) translateY(-20.48px);}
52.50% { transform: translateX(15px) translateY(-24.24px);}
53.00% { transform: translateX(18px) translateY(-27.66px);}
53.50% { transform: translateX(21px) translateY(-30.79px);}
54.00% { transform: translateX(24px) translateY(-33.66px);}
54.50% { transform: translateX(27px) translateY(-36.31px);}
55.00% { transform: translateX(30px) translateY(-38.76px);}
55.50% { transform: translateX(33px) translateY(-41.02px);}
56.00% { transform: translateX(36px) translateY(-43.11px);}
56.50% { transform: translateX(39px) translateY(-45.04px);}
57.00% { transform: translateX(42px) translateY(-46.83px);}
57.50% { transform: translateX(45px) translateY(-48.48px);}
58.00% { transform: translateX(48px) translateY(-50px);}
58.50% { transform: translateX(51px) translateY(-51.39px);}
59.00% { transform: translateX(54px) translateY(-52.67px);}
59.50% { transform: translateX(57px) translateY(-53.83px);}
60.00% { transform: translateX(60px) translateY(-54.89px);}
60.50% { transform: translateX(63px) translateY(-55.84px);}
61.00% { transform: translateX(66px) translateY(-56.68px);}
61.50% { transform: translateX(69px) translateY(-57.43px);}
62.00% { transform: translateX(72px) translateY(-58.08px);}
62.50% { transform: translateX(75px) translateY(-58.64px);}
63.00% { transform: translateX(78px) translateY(-59.1px);}
63.50% { transform: translateX(81px) translateY(-59.46px);}
64.00% { transform: translateX(84px) translateY(-59.74px);}
64.50% { transform: translateX(87px) translateY(-59.93px);}
65.00% { transform: translateX(90px) translateY(-60px);}
65.50% { transform: translateX(93px) translateY(-59.92px);}
66.00% { transform: translateX(96px) translateY(-59.7px);}
66.50% { transform: translateX(99px) translateY(-59.32px);}
67.00% { transform: translateX(102px) translateY(-58.79px);}
67.50% { transform: translateX(105px) translateY(-58.09px);}
68.00% { transform: translateX(108px) translateY(-57.24px);}
68.50% { transform: translateX(111px) translateY(-56.2px);}
69.00% { transform: translateX(114px) translateY(-54.99px);}
69.50% { transform: translateX(117px) translateY(-53.58px);}
70.00% { transform: translateX(120px) translateY(-51.96px);}
70.50% { transform: translateX(123px) translateY(-50.11px);}
71.00% { transform: translateX(126px) translateY(-48px);}
71.50% { transform: translateX(129px) translateY(-45.6px);}
72.00% { transform: translateX(132px) translateY(-42.85px);}
72.50% { transform: translateX(135px) translateY(-39.69px);}
73.00% { transform: translateX(138px) translateY(-36px);}
73.50% { transform: translateX(141px) translateY(-31.61px);}
74.00% { transform: translateX(144px) translateY(-26.15px);}
74.50% { transform: translateX(147px) translateY(-18.73px);}
75.00% { transform: translateX(150px) translateY(0px);}
75.50% { transform: translateX(147px) translateY(18.73px);}
76.00% { transform: translateX(144px) translateY(26.15px);}
76.50% { transform: translateX(141px) translateY(31.61px);}
77.00% { transform: translateX(138px) translateY(36px);}
77.50% { transform: translateX(135px) translateY(39.69px);}
78.00% { transform: translateX(132px) translateY(42.85px);}
78.50% { transform: translateX(129px) translateY(45.6px);}
79.00% { transform: translateX(126px) translateY(48px);}
79.50% { transform: translateX(123px) translateY(50.11px);}
80.00% { transform: translateX(120px) translateY(51.96px);}
80.50% { transform: translateX(117px) translateY(53.58px);}
81.00% { transform: translateX(114px) translateY(54.99px);}
81.50% { transform: translateX(111px) translateY(56.2px);}
82.00% { transform: translateX(108px) translateY(57.24px);}
82.50% { transform: translateX(105px) translateY(58.09px);}
83.00% { transform: translateX(102px) translateY(58.79px);}
83.50% { transform: translateX(99px) translateY(59.32px);}
84.00% { transform: translateX(96px) translateY(59.7px);}
84.50% { transform: translateX(93px) translateY(59.92px);}
85.00% { transform: translateX(90px) translateY(60px);}
85.50% { transform: translateX(87px) translateY(59.93px);}
86.00% { transform: translateX(84px) translateY(59.74px);}
86.50% { transform: translateX(81px) translateY(59.46px);}
87.00% { transform: translateX(78px) translateY(59.1px);}
87.50% { transform: translateX(75px) translateY(58.64px);}
88.00% { transform: translateX(72px) translateY(58.08px);}
88.50% { transform: translateX(69px) translateY(57.43px);}
89.00% { transform: translateX(66px) translateY(56.68px);}
89.50% { transform: translateX(63px) translateY(55.84px);}
90.00% { transform: translateX(60px) translateY(54.89px);}
90.50% { transform: translateX(57px) translateY(53.83px);}
91.00% { transform: translateX(54px) translateY(52.67px);}
91.50% { transform: translateX(51px) translateY(51.39px);}
92.00% { transform: translateX(48px) translateY(50px);}
92.50% { transform: translateX(45px) translateY(48.48px);}
93.00% { transform: translateX(42px) translateY(46.83px);}
93.50% { transform: translateX(39px) translateY(45.04px);}
94.00% { transform: translateX(36px) translateY(43.11px);}
94.50% { transform: translateX(33px) translateY(41.02px);}
95.00% { transform: translateX(30px) translateY(38.76px);}
95.50% { transform: translateX(27px) translateY(36.31px);}
96.00% { transform: translateX(24px) translateY(33.66px);}
96.50% { transform: translateX(21px) translateY(30.79px);}
97.00% { transform: translateX(18px) translateY(27.66px);}
97.50% { transform: translateX(15px) translateY(24.24px);}
98.00% { transform: translateX(12px) translateY(20.48px);}
98.50% { transform: translateX(9px) translateY(16.3px);}
99.00% { transform: translateX(6px) translateY(11.62px);}
99.50% { transform: translateX(3px) translateY(6.28px);}
